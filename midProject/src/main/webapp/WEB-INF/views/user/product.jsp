...
<body>
				...
				<div class="col-lg-12">
					<div class="breadcrumb-text product-more">
						<a href="./main.do"><i class="fa fa-home"></i> Home</a> <a
							href="./shop.do">Shop</a> <span>Detail</span>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="col-lg-6">
							<div class="product-pic-zoom">
								<img class="product-big-img"
									src="<c:url value='../resources/img/products/${productInfo.g_rimg3}' />"
									alt="Product_Main_Thumbnail">
								<div class="zoom-icon">
							...
							<div class="product-thumbs">
								<div class="product-thumbs-track ps-slider owl-carousel">
									<!-- 이미지 -->
									<div class="pt active"
										data-imgbigurl="<c:url value='../resources/img/products/${productInfo.g_rimg3}' />">
										<img
											src="<c:url value='../resources/img/products/${productInfo.g_rimg3}' />"
											alt="Product_Main_Thumbnail">
									</div>
							...
							<div class="product-details">
								...
								<div class="rental-info-details">
									...
									<div class="pd-desc">
										...
										<dl>
											<dt>공급사</dt>
											<c:forEach items="${supInfo}" var="supplier"
												varStatus="status">
								            ${supplier.s_name}
								...
								<div class="rental-info-details2">
									<table class="pd-desc2">
										<tr>
											...
											<td class="min_price">최저렌탈가<a>월<span
													class="formatted-number">${minPrice.p_price }</span>원
											</a></td>
											<td class="max_discount">카드할인가<a>월<span
													class="formatted-number">${minPrice.p_card }</span>원
											</a></td>
										</tr>
									</table>
								</div>
							...
							<div class="tab-item">
								<ul class="nav" id="tab-menu">
									<li><a class="active" data-toggle="tab" href="#tab-1"
										role="tab">RENTAL OPTION</a></li>
									<li><a data-toggle="tab" href="#tab-2" role="tab">DESCRIPTION</a>
									</li>
									<li><a data-toggle="tab" href="#tab-3" role="tab">REVIEWS
											(${reviewCnt})</a></li>
								</ul>
							</div>
							<div class="tab-item-content">
								<div class="tab-content">
													...
													<div class="price_detail">
														...
														<div class="btn_choice_box1">
															<c:forEach items="${priceInfoList}" var="rental_price">
																<div class="choice_m">
																	<button type="button"
																		data-rentalperiod="${rental_price.p_rent}"
																		class="rentalPeriod">
																		<a>${rental_price.p_rent}개월</a>
																		<p class="price03">
																			<span class="formatted-number">${rental_price.p_price}</span>원
																		</p>
																	</button>
																</div>
															</c:forEach>
									...
									<div class="tab-pane fade" id="tab-2" role="tabpanel">
										<img
											src="<c:url value='../resources/img/products/${productInfo.g_rimg4}' />"
											alt="Product_Detail">
									</div>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$(
					".btn_choice_box1 .rentalPeriod:first, .btn_choice_box1 .rentalPeriod:first p, .btn_choice_box1 .rentalPeriod:first a")
					.addClass("on");

			// rentalPeriod 버튼 클릭 시
			$(".btn_choice_box1 .rentalPeriod")
					.click(
							function() {
								// on 클래스 제거
								$(
										".btn_choice_box1 .rentalPeriod, .btn_choice_box1 .rentalPeriod:first p, .btn_choice_box1 .rentalPeriod:first a")
										.removeClass("on");
			...
			var defaultSelectedMonths = $(
					".btn_choice_box1 .rentalPeriod:first")
					.data('rentalperiod');
									...
									.forEach(function(item) {
										...
										tr
												.append($('<td>')
														.addClass('sub_Title')
														.html(
																'<div class="sub_logo_img"><img style="width: 50px;" src="/midProject/resources/img/sup_logo/' + item.s_name + '.png"></div><p>'
																		+ item.s_name
																		+ '</p>'));

										// 숫자 포맷팅 적용
										var formattedPrice = item.p_price
												.toLocaleString('en');
										var formattedCardPrice = item.p_card
												.toLocaleString('en');
										var formattedGift = item.p_gift
												.toLocaleString('en');
										...
										tr
												.append($('<td>')
														.addClass('sub_Info')
														.html(
																'<div class="join_condition"><div id="join_condition" name="join_condition" rows="2" cols="30" readonly>'
																		+ item.p_text
																		+ '</div></div><div class="btn_choice_box_con"><button type="button" class="btn-card" onclick="openAffiliateCard()">제휴카드보기&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/></svg></button></div>'));

										tr
												.append($('<td>')
														.addClass('sub_Info2')
														.html(
																'<div class="sub_info_box_rental"><table summary="요약" class="info_box"><tbody><tr style="padding: 0px; border: none; margin: 0;"><td class="sub_info_box1">월렌탈요금<br/><a style="color: #1478FF;">월<span style="font-weight: bold;" class="formatted-number">'
																		+ formattedPrice
																		+ '</span>원</a></td><td class="sub_info_box2">카드할인가<br/><a style="color: #B93232;">월<span style="font-weight: bold;" class="formatted-number">'
																		+ formattedCardPrice
																		+ '</span>원</a></td><td class="sub_info_box3">사은품 혜택<br/><a style="color: #000069;"><span style="font-weight: bold;" class="formatted-number">'
																		+ formattedGift
																		+ '</span>P</a></td></tr></tbody></table></div><div class="btn_choice_box2"><button type="button" class="btn-cart" onclick="addToCart()">장바구니</button><button type="button" class="btn-rental" onclick="applyForRental()">렌탈신청</button></div>'));
