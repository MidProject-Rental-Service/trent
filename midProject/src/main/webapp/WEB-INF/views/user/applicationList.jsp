...
<link rel="stylesheet" href="../css/rent-applicationList-style.css"
	type="text/css" />
<style type="text/css">
input#datepicker1.hasDatepicker, input#datepicker2.hasDatepicker {
	text-align: center;
	width: 90%
}
</style>
			...
			<div class="nav-depart">
				<div class="depart-btn">
					...
					<ul class="depart-hover">
						<li class="active"><a
							href="./shop_search.do?searchCondition=total&searchKeyword=공기청정기">공기청정기</a></li>
						<li><a
							href="./shop_search.do?searchCondition=total&searchKeyword=가습기">가습기</a></li>
						<li><a
							href="./shop_search.do?searchCondition=total&searchKeyword=제습기">제습기</a></li>
					</ul>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="breadcrumb-text">
						<a href="main.do"><i class="fa fa-home"></i> Home</a><a
							href="mypage.do"> Mypage</a> <span>신청목록</span>
					</div>
				</div>
			</div>
		</div>
									...
									<tr>
										...
										<td><c:choose>
												...
												<c:when test="${userRental.b_stat == 5}">
					                                설치완료
					                                <input type="submit"
														name="confirm-btn" class="btn btn-warning correct-btn"
														value="구매확정">
												</c:when>
