		...
		<div class="body-wrapper">
			...
			<div class="container">
				...
				<section id="container">
					...
					<form action = "usermange.do" name = "pageForm" method="post">
					...
					<form action="usermange.do" method="post">
					    <div class="search-wrap" style="display: flex; align-items: center;"> <!-- 인라인 스타일 추가 -->
					        <select class="form-control search-select" name="searchCondition"  > <!-- 인라인 스타일 추가 -->
					            <option value="name" ${pageVO.cri.searchCondition eq 'name' ? 'selected' : '' }>이름</option>
					            <option value="phone" ${pageVO.cri.searchCondition eq 'phone' ? 'selected' : '' }>휴대폰번호</option>
