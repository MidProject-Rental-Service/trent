	...
	<div class="page-wrapper" id="main-wrapper" data-layout="vertical"
		...
		<div class="container">
			...
			<section id="container">
				...
				<form action = "supplyinquiry.do" name = "pageForm" method="post">
				...
				<form action="supplyinquiry.do" method="post">
				    <div class="search-wrap" style="display: flex; align-items: center;"> <!-- 인라인 스타일 추가 -->
				        <select class="form-control search-select" name="searchCondition"  > <!-- 인라인 스타일 추가 -->
				            ...
				            <option value="name" ${pageVO.cri.searchCondition eq 'id' ? 'selected' : '' }>공급사명</option>
