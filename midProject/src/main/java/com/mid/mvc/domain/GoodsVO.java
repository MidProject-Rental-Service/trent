...
public class GoodsVO {
	...
	public void setFile1(MultipartFile file1) {
	    ...
	    if (!file1.isEmpty()) {
	        ...
	        // 실제 파일 저장
	        // 나중에 웹서버 경로를 찾아서 수정
	        File f = new File("D:\\trent\\midProject\\src\\main\\webapp\\resources\\img\\products\\" + g_rimg1);
	...
	public void setFile2(MultipartFile file2) {
	    ...
	    if (!file2.isEmpty()) {
	        ...
	        // 실제 파일 저장
	        // 나중에 웹서버 경로를 찾아서 수정
	        File f = new File("D:\\trent\\midProject\\src\\main\\webapp\\resources\\img\\products\\" + g_rimg2);
	...
	public void setFile3(MultipartFile file3) {
	    ...
	    if (!file3.isEmpty()) {
	        ...
	        // 실제 파일 저장
	        // 나중에 웹서버 경로를 찾아서 수정
	        File f = new File("D:\\trent\\midProject\\src\\main\\webapp\\resources\\img\\products\\" + g_rimg3);
	...
	public void setFile4(MultipartFile file4) {
	    ...
	    if (!file4.isEmpty()) {
	        ...
	        // 실제 파일 저장
	        // 나중에 웹서버 경로를 찾아서 수정
	        File f = new File("D:\\trent\\midProject\\src\\main\\webapp\\resources\\img\\products\\" + g_rimg4);
